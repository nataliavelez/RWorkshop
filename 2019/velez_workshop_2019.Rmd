...
(Note: This step is pretty idiosyncratic to this particular dataset. When you design your own spreadsheets, you should organize them so that they're easier to analyze! :) In general, the more datasets you analyze with R, the better able you'll be at organizing your data so that they're easier to clean up to begin with.)
